...
tcp_server_error_t tcp_server_change_address(
    struct tcp_pcb *tpcb, tcp_server_struct_t *es, uint8_t *ipaddr, uint8_t *netmask, uint8_t *gateway);
tcp_server_error_t tcp_server_send_response(struct tcp_pcb *tpcb, tcp_server_struct_t *es, const cJSON *resp);
